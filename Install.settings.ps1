...
Properties {
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage('PSUseDeclaredVarsMoreThanAssigments', '')]
    $MyGet=@{
       Modules=@('Log4Posh','MeasureLocalizedData','DTW.PS.FileSystem','Template','OptimizationRules','ParameterSetRules') #todo remove call log4net ,'OptimizationRules','ParameterSetRules')
